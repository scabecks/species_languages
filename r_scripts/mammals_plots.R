...
sp = read_csv("tabular_data/pablo_mammals.csv",col_types = 'iiiii')
...
map = ggplot(
  ...
  labs(x = NULL,
         y = NULL,
         title = "Mammalian Richness vs. Languages Spoken",
         subtitle = "IUCN Mammal Ranges and Average (Official) Spoken Languages per Species' Range",
...
ggsave("figures/mammals_fig1.png", dpi = 600)

#Trim off any unwanted margins
system("convert figures/mammals_fig1.png -trim figures/mammals_fig1_trim.png")
