...
sp = read_csv("tabular_data/pablo_reptiles.csv",col_types = 'iiiii')
...
map = ggplot(
  ...
  labs(x = NULL,
         y = NULL,
         title = "Reptilian Richness vs. Languages Spoken",
         subtitle = "IUCN Reptile Ranges and Average (Official) Spoken Languages per Species' Range",
...
ggsave("figures/reptiles_fig1.png", dpi = 600)

#Trim off any unwanted margins
system("convert figures/reptiles_fig1.png -trim figures/reptiles_fig1_trim.png")
